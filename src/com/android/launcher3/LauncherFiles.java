...
public class LauncherFiles {
    ...
    public static final String SHARED_PREFERENCES_KEY = BuildConfig.APPLICATION_ID +"preferences";
    ...
    public static final String DEVICE_PREFERENCES_KEY = BuildConfig.APPLICATION_ID +"device.prefs";
