...
public class DeviceProfile {
    ...
    public DeviceProfile(Context context, InvariantDeviceProfile inv,
        ...
        cellLayoutPaddingLeftRightPx = (!isVerticalBarLayout() &&
                Utilities.getZimPrefs(mContext).getAllowFullWidthWidgets()) ? 0
        ...
        float hotseatScale = Utilities.getZimPrefs(mContext).getHotseatHeightScale();
    ...
    public int getHotseatBottomPadding(Resources res) {
        return res.getDimensionPixelSize(Utilities.getZimPrefs(mContext).getDockSearchBar() ?
    ...
    public Rect getWorkspacePadding(Rect recycle) {
        ...
        if (isVerticalBarLayout()) {
            ...
            if (Utilities.getZimPrefs(mContext).getAllowFullWidthWidgets()) {
    ...
    public void layout(Launcher launcher, boolean notifyListeners) {
        ...
        boolean hideHotseat = Utilities.getZimPrefs(mContext).getTransparentHotseat() && Utilities.getZimPrefs(mContext).getHideHotseat();
