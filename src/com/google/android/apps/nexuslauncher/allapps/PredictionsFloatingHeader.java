...
public class PredictionsFloatingHeader extends FloatingHeaderView implements Insettable {
    ...
    /*protected void updateExpectedHeight() {
        ...
        AppsDividerView.DividerType dividerType = AppsDividerView.DividerType.NONE;
        if (useAllAppsLabel) {
            dividerType = AppsDividerView.DividerType.ALL_APPS_LABEL;
        } else if (mTabsHidden) {
            dividerType = AppsDividerView.DividerType.LINE;
        }
