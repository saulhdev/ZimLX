...
import org.zimmob.zimlx.util.NavigationBarCompat
...
class NavigationBarGestureConsumer(private val context: Context, target: TouchConsumer,
    ...
    private val launcher get() = LauncherAppState.getInstance(context).launcher as? ZimLauncher
    ...
    private val swipeForBack = launcher != null && context.zimPrefs.swipeLeftToGoBack
    ...
    private fun performBackPress(): Boolean {
        ...
        return context.zimApp.performGlobalAction(AccessibilityService.GLOBAL_ACTION_BACK)
    }
...
class NavSwipeUpGesture(controller: GestureController) : Gesture(controller) {
    ...
    override val isEnabled = OverviewInteractionState.INSTANCE.get(controller.launcher).isSwipeUpGestureEnabled
