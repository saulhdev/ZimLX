...
import org.zimmob.zimlx.gestures.handlers.VerticalSwipeGestureHandler
...
class VerticalSwipeGestureController(private val launcher: Launcher) : TouchController, SwipeDetector.Listener {
    ...
    private val controller by lazy { ZimLauncher.getLauncher(launcher).gestureController }
