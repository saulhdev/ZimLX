...
class ZimShortcutActivity : SettingsBaseActivity() {
    ...
    companion object {
        const val START_ACTION = "org.zimmob.zimlx.START_ACTION"
        const val EXTRA_HANDLER = "org.zimmob.zimlx.EXTRA_HANDLER"
