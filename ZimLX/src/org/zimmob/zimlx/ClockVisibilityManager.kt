...
class ClockVisibilityManager(private val context: Context) {
    ...
    private val enabledPref by context.zimPrefs.BooleanPref(
    ...
    private fun refreshHideClockState() {
        hideStatusBarClock = clockVisibleOnHome
                ...
                && enabledPref && context.zimPrefs.smartspaceTime
    }
    ...
    companion object : ZimSingletonHolder<ClockVisibilityManager>(::ClockVisibilityManager) {
