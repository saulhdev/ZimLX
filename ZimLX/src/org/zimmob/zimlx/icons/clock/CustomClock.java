...
public class CustomClock {
        ...
        if (normalizeIcon) {
            ...
            layers.bitmap = obtain.createBadgedIconBitmap(
                    new AdaptiveIconDrawable(
                            layers.mDrawable.getBackground().getConstantState().newDrawable(), null),
    ...
    public FastBitmapDrawable drawIcon(ItemInfoWithIcon info, Drawable drawableForDensity, Metadata metadata) {
