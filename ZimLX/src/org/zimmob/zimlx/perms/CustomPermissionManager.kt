...
class CustomPermissionManager private constructor(private val context: Context) {
    private var grantedPerms by context.zimPrefs.StringSetPref("pref_grantedCustomPerms", emptySet())
    private var deniedPerms by context.zimPrefs.StringSetPref("pref_deniedCustomPerms", emptySet())
    ...
    companion object : ZimSingletonHolder<CustomPermissionManager>(::CustomPermissionManager) {
        /**
