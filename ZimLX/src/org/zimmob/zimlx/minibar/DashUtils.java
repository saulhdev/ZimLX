...
public class DashUtils {
    public static DashItem[] actionDisplayItems = new DashItem[]{
            DashItem.asCustomItem(Action.AppDrawer, "App Drawer", Launcher.mContext.getString(R.string.minibar_8), R.drawable.ic_apps_24dp, 17),
            DashItem.asCustomItem(Action.EditMinibar, "Edit Minibar", Launcher.mContext.getString(R.string.minibar_0), R.drawable.ic_mode_edit_black_24dp, 10),
            DashItem.asCustomItem(Action.SetWallpaper, "Set Wallpaper", Launcher.mContext.getString(R.string.minibar_1), R.drawable.ic_photo_black_24dp, 11),
            DashItem.asCustomItem(Action.LauncherSettings, "Launcher Settings", Launcher.mContext.getString(R.string.minibar_5), R.drawable.ic_settings_launcher_black_24dp, 12),
            DashItem.asCustomItem(Action.VolumeDialog, "Volume Dialog", Launcher.mContext.getString(R.string.minibar_7), R.drawable.ic_volume_up_black_24dp, 13),
            DashItem.asCustomItem(Action.DeviceSettings, "Device Settings", Launcher.mContext.getString(R.string.minibar_4), R.drawable.ic_build, 14),
            DashItem.asCustomItem(Action.MobileNetworkSettings, "Mobile Network Settings", Launcher.mContext.getString(R.string.minibar_10), R.drawable.ic_network_24dp, 15),
