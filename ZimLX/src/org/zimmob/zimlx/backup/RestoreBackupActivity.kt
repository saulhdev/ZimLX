...
class RestoreBackupActivity : SettingsBaseActivity(), ZimBackup.MetaLoader.Callback {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        when {
            ...
            intent.hasExtra(EXTRA_SUCCESS) -> {
                ...
                Utilities.getZimPrefs(this).blockingEdit { restoreSuccess = false }
    ...
    override fun onMetaLoaded() {
        ...
        if (backup.meta != null) {
            ...
            val includeHomescreen = contents and ZimBackup.INCLUDE_HOMESCREEN != 0
            backupHomescreen.isEnabled = includeHomescreen
            backupHomescreen.isChecked = includeHomescreen
            val includeSettings = contents and ZimBackup.INCLUDE_SETTINGS != 0
            backupSettings.isEnabled = includeSettings
            backupSettings.isChecked = includeSettings
            val includeWallpaper = contents and ZimBackup.INCLUDE_WALLPAPER != 0
        ...
        override fun onPostExecute(result: Int) {
            ...
            if (result > -1) {
                ...
                if (result and ZimBackup.INCLUDE_SETTINGS == 0) {
                    Utilities.getZimPrefs(this@RestoreBackupActivity).blockingEdit {
                        restoreSuccess = true
                    }
                }
