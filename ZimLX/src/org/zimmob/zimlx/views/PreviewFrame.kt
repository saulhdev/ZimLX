...
import org.zimmob.zimlx.dragndrop.CustomWidgetDragListener
import org.zimmob.zimlx.util.childs

class PreviewFrame(context: Context, attrs: AttributeSet?) : FrameLayout(context, attrs), View.OnLongClickListener {
