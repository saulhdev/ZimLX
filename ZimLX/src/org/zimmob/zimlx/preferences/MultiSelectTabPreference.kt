...
import org.zimmob.zimlx.groups.ui.AppCategorizationFragment
import org.zimmob.zimlx.settings.SettingsActivity
import org.zimmob.zimlx.util.addOrRemove
...
class MultiSelectTabPreference(context: Context, attrs: AttributeSet?) : LauncherRecyclerViewPreference(context, attrs) {
    ...
    private val tabs = context.zimPrefs.drawerTabs.getGroups().mapNotNull { it as? DrawerTabs.CustomTab }
    var edited = false
        private set(value) {
            field = value
        }
