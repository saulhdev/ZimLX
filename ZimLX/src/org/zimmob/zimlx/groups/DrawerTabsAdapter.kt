...
import org.zimmob.zimlx.groups.ui.AppGroupsAdapter
import org.zimmob.zimlx.preferences.DrawerTabTypeSelectionBottomSheet
...
open class DrawerTabsAdapter(context: Context) : AppGroupsAdapter<DrawerTabsAdapter.TabHolder, DrawerTabs.Tab>(context) {
    ...
    private val hasWorkApps = context.zimPrefs.separateWorkApps
