...
import org.zimmob.zimlx.util.createDisabledColor
import org.zimmob.zimlx.util.isVisible
import org.zimmob.zimlx.util.tintDrawable
...
abstract class AppGroupsAdapter<VH : AppGroupsAdapter<VH, T>.GroupHolder, T : AppGroups.Group>(val context: Context)
    ...
    protected val manager = context.zimPrefs.appGroupsManager
    protected val items = ArrayList<Item>()
    protected val accent = context.zimPrefs.accentColor
