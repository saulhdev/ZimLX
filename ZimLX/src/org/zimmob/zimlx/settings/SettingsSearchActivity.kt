...
import kotlinx.android.synthetic.zim.activity_settings_search.*
import org.zimmob.zimlx.settings.SettingsActivity.EXTRA_FRAGMENT_ARG_KEY
import org.zimmob.zimlx.settings.SettingsActivity.SubSettingsFragment.*
import org.zimmob.zimlx.settings.search.SearchIndex
    ...
    private fun doSearch(query: String) {
        ...
        if (query.startsWith("..")) {
            ...
            if (debugCommand.hash("SHA-1").endsWith(BuildConfig.DEBUG_MENU_CODE_HASH)) {
                zimPrefs.debugMenuEnabled = !zimPrefs.debugMenuEnabled
