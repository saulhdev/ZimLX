...
import com.android.launcher3.util.SecureSettingsObserver.NOTIFICATION_BADGING
import org.zimmob.zimlx.BlankActivity
import org.zimmob.zimlx.settings.SettingsActivity
import org.zimmob.zimlx.settings.SettingsActivity.SubSettingsFragment.CONTENT_RES_ID
import org.zimmob.zimlx.settings.SettingsActivity.SubSettingsFragment.TITLE
import org.zimmob.zimlx.util.Temperature
import org.zimmob.zimlx.util.checkPackagePermission
...
class ZimSmartspaceController(val context: Context) {
    ...
    private val weatherProviderPref = Utilities.getZimPrefs(context)::weatherProvider
    private val eventProvidersPref = context.zimPrefs.eventProviders
    ...
    abstract class PeriodicDataProvider(controller: ZimSmartspaceController) : DataProvider(controller) {
