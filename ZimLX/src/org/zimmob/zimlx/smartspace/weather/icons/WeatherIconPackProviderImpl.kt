...
package org.zimmob.zimlx.smartspace.weather.icons

import android.content.Context
import android.graphics.Bitmap
import com.android.launcher3.R
import org.zimmob.zimlx.util.toBitmap
...
class WeatherIconPackProviderImpl(private val context: Context, private val pkgName: String,
                                  private val pack: WeatherIconManager.WeatherIconPack) : WeatherIconManager.IconProvider {
    ...
    companion object {
        ...
        fun getResName(icon: WeatherIconManager.Icon, night: Boolean) = PREFIX + (MAP[icon]?.getEntry(night)
                ?: NA)
    }
