package org.zimmob.zimlx.workspace;
...
import org.zimmob.zimlx.folder.FolderInfo;
...
import org.zimmob.zimlx.dragndrop.DragOptionLayout;
...
public class Desktop extends SmoothViewPager implements IDesktopCallback<View> {
    ...
    public void updateIconBadges(Set<PackageUserKey> updateBadges){
