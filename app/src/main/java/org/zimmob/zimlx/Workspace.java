...
import org.zimmob.zimlx.accessibility.OverviewAccessibilityDelegate;
import org.zimmob.zimlx.accessibility.OverviewScreenAccessibilityDelegate;
import org.zimmob.zimlx.accessibility.WorkspaceAccessibilityHelper;
...
import org.zimmob.zimlx.dragndrop.DragScroller;
import org.zimmob.zimlx.dragndrop.DragView;
import org.zimmob.zimlx.dragndrop.SpringLoadedDragController;
...
import org.zimmob.zimlx.graphics.DragPreviewProvider;
...
import org.zimmob.zimlx.util.WallpaperOffsetInterpolator;
import org.zimmob.zimlx.widget.PendingAddShortcutInfo;
...
public class Workspace extends PagedView
    ...
    public final static float START_DAMPING_TOUCH_SLOP_ANGLE = (float) Math.PI / 6;
    public final static float MAX_SWIPE_ANGLE = (float) Math.PI / 3;
    public final static float TOUCH_SLOP_DAMPING_FACTOR = 4;
    ...
    private void onDropExternal(final int[] touchXY, final ItemInfo dragInfo,
        ...
        final Runnable exitSpringLoadedRunnable = () -> mLauncher.exitSpringLoadedDragModeDelayed(true,
    ...
    public void removeItemsByMatcher(final ItemInfoMatcher matcher) {
        ...
        for (final CellLayout layoutParent : cellLayouts) {
            ...
            LauncherModel.ItemInfoFilter filter = (parent, info, cn) -> {
