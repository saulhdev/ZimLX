...
class DrawableUtils {
    ...
    companion object {
        ...
        fun inflateFromXml(drawableInflater: Any, parser: XmlPullParser) = inflateFromXml(drawableInflater, parser, null)

        fun inflateFromXml(drawableInflater: Any, parser: XmlPullParser, theme: Resources.Theme?) = inflateFromXml(drawableInflater, parser, Xml.asAttributeSet(parser), theme)
