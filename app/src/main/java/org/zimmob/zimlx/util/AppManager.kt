...
import org.zimmob.zimlx.core.interfaces.AppDeleteListener
...
class AppManager(val context: Context) : Setup.AppLoader<AppManager.App> {
    ...
    override fun addUpdateListener(updateListener: AppUpdateListener<App>) {
        updateListeners.add(updateListener)
    }

    override fun removeUpdateListener(updateListener: AppUpdateListener<App>) {
        updateListeners.remove(updateListener)
    }

    override fun addDeleteListener(deleteListener: AppDeleteListener<App>) {
        deleteListeners.add(deleteListener)
    }

    override fun removeDeleteListener(deleteListener: AppDeleteListener<App>) {
