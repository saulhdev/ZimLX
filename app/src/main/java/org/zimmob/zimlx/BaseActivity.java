...
import org.zimmob.zimlx.DeviceProfile.OnDeviceProfileChangeListener;
import org.zimmob.zimlx.logging.UserEventDispatcher;
...
import static org.zimmob.zimlx.logging.UserEventDispatcher.UserEventDelegate;
import static org.zimmob.zimlx.logging.UserEventDispatcher.newInstance;
import static org.zimmob.zimlx.userevent.nano.LauncherLogProto.LauncherEvent;
import static org.zimmob.zimlx.util.SystemUiController.UI_STATE_OVERVIEW;
...
public abstract class BaseActivity extends Activity implements UserEventDelegate {
    ...
    public void modifyUserEvent(LauncherEvent event) {
    }
    ...
    public final UserEventDispatcher getUserEventDispatcher() {
        if (mUserEventDispatcher == null) {
            mUserEventDispatcher = newInstance(this, mDeviceProfile, this);
        }
