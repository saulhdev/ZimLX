...
import org.zimmob.zimlx.Insettable;
...
public class BottomUserEducationView extends AbstractSlideInView implements Insettable {
    ...
    public static void showIfNeeded(Launcher launcher) {
        if (Utilities.getSharedPrefs(launcher).getBoolean(KEY_SHOWED_BOTTOM_USER_EDUCATION, false)) {
            return;
        }
    ...
    protected void handleClose(boolean animate) {
        ...
        if (animate) {
            ...
            Launcher.getLauncher(getContext()).isEditingDisabled();
            Utilities.getSharedPrefs(getContext()).edit()
