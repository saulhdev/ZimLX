...
open class PreferenceImpl(context: Context) : IPreferenceProvider {
    ...
    private open inner class StringPref(key: String? = null, defaultValue: String = "") :
        ...
        override fun getValue(thisRef: Any?, property: KProperty<*>): String = sharedPrefs.getString(key
    ...
    private open inner class StringSetPref(key: String? = null, defaultValue: Set<String>? = null) :
        ...
        override fun getValue(thisRef: Any?, property: KProperty<*>): Set<String>? = sharedPrefs.getStringSet(key
                ?: property.name, defaultValue)
    }
    ...
    private open inner class FloatPref(key: String? = null, defaultValue: Float = 0f) :
        ...
        override fun getValue(thisRef: Any?, property: KProperty<*>): Float = sharedPrefs.getFloat(key
                ?: property.name, defaultValue)
    }
    ...
    private open inner class BooleanPref(key: String? = null, defaultValue: Boolean = false) :
        ...
        override fun getValue(thisRef: Any?, property: KProperty<*>): Boolean = sharedPrefs.getBoolean(key
                ?: property.name, defaultValue)
    }
