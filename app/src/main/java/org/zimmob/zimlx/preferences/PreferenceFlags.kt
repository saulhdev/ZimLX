...
object PreferenceFlags {
    ...
    //const val KEY_NUM_ROWS = "pref_num_rows"
    //const val KEY_NUM_COLS = "pref_num_cols"
    ...
    //const val KEY_PREF_NUM_PREDICTIVE_APPS="pref_predictive_apps_values";
    // Strings
    ...
    const val KEY_PREF_NUM_COLS = "pref_key__num_cols"
    const val KEY_PREF_NUM_COLS_DRAWER = "pref_numColsDrawer"
    const val KEY_PREF_NUM_ROWS = "pref_key__num_rows"
    ...
    const val KEY_PREF_DRAWER_VERTICAL_LAYOUT = "pref_key__drawer_style"
