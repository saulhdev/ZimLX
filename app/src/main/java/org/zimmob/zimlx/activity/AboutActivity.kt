...
class AboutActivity : MaterialAboutActivity() {
    ...
    override fun getMaterialAboutList(context: Context): MaterialAboutList {
        ...
        opAuthorCard.title(getString(R.string.about_author))
        opAuthorCard.addItem(MaterialAboutActionItem.Builder()
                .text(R.string.about_author_name)
                .subText(getString(R.string.about_author_email))
                .build())
