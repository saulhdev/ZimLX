...
import org.zimmob.zimlx.WidgetPreviewLoader;
...
public class WidgetCell extends LinearLayout implements OnLayoutChangeListener {
    ...
    public void applyFromCellItem(WidgetItem widgetItem, WidgetPreviewLoader widgetPreviewLoader) {
        ...
        this.mWidgetDims.setText(getContext().getString(R.string.widget_dims_format, this.mItem.spanX, this.mItem.spanY));
