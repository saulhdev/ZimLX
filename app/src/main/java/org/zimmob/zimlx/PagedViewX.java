...
import org.zimmob.zimlx.anim.Interpolators;
import org.zimmob.zimlx.config.FeatureFlags;
import org.zimmob.zimlx.pageindicators.IPageIndicator;
import org.zimmob.zimlx.touch.OverScroll;
...
import static org.zimmob.zimlx.compat.AccessibilityManagerCompat.isObservedEventType;

/**
 * An abstraction of the original Workspace which supports browsing through a
 * sequential list of "pages"
 */
public abstract class PagedViewX<T extends View & IPageIndicator> extends ViewGroup {
    ...
    public PagedViewX(Context context) {
        this(context, null);
    }

    public PagedViewX(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public PagedViewX(Context context, AttributeSet attrs, int defStyle) {
