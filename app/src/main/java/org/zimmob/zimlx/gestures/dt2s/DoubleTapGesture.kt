...
import org.zimmob.zimlx.gestures.Gesture
...
import org.zimmob.zimlx.receiver.DeviceAdminReceiver
    ...
    class SleepGestureHandlerDeviceAdmin(launcher: Launcher) : GestureHandler(launcher) {
        ...
        override fun onGestureTrigger() {
            ...
            if (devicePolicyManager != null) {
                if (devicePolicyManager.isAdminActive(ComponentName(launcher, DeviceAdminReceiver::class.java))) {
                    devicePolicyManager.lockNow()
                } else {
                    val intent = Intent(DevicePolicyManager.ACTION_ADD_DEVICE_ADMIN)
                    intent.putExtra(DevicePolicyManager.EXTRA_DEVICE_ADMIN, ComponentName(launcher, DeviceAdminReceiver::class.java))
