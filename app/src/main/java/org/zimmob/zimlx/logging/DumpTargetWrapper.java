...
import org.zimmob.zimlx.LauncherAppWidgetInfo;
import org.zimmob.zimlx.LauncherSettings;
import org.zimmob.zimlx.userevent.nano.LauncherDumpProto;
import org.zimmob.zimlx.userevent.nano.LauncherDumpProto.ContainerType;
import org.zimmob.zimlx.userevent.nano.LauncherDumpProto.DumpTarget;
import org.zimmob.zimlx.userevent.nano.LauncherDumpProto.ItemType;
import org.zimmob.zimlx.userevent.nano.LauncherDumpProto.UserType;
...
public class DumpTargetWrapper {
    ...
    public DumpTarget writeToDumpTarget(ItemInfo info) {
        ...
        node.userType = (info.user.equals(Process.myUserHandle())) ? LauncherDumpProto.UserType.DEFAULT : UserType.WORK;
        return node;
    }
}
