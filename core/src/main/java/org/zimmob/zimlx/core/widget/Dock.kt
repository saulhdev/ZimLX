...
import org.zimmob.zimlx.core.util.DragNDropHandler
import org.zimmob.zimlx.core.util.Tool
import org.zimmob.zimlx.core.util.toPx
import org.zimmob.zimlx.core.viewutil.DesktopCallBack
import org.zimmob.zimlx.core.viewutil.ItemViewFactory
...
class Dock @JvmOverloads constructor(c: Context, attr: AttributeSet? = null) : CellContainer(c, attr), DesktopCallBack<View> {
    ...
    override fun onTouchEvent(evt: MotionEvent): Boolean = super.onTouchEvent(evt)
