package org.zimmob.zimlx.core.widget
...
import org.zimmob.zimlx.core.drawable.LauncherCircleDrawable
import org.zimmob.zimlx.core.interfaces.AbstractApp
import org.zimmob.zimlx.core.interfaces.AppUpdateListener
import org.zimmob.zimlx.core.interfaces.SettingsManager
import org.zimmob.zimlx.core.manager.Setup
import org.zimmob.zimlx.core.model.IconLabelItem
...
class SearchBar : FrameLayout {
    ...
    init {
        ...
        icon2 = LauncherCircleDrawable(context, context.getDrawable(if (Setup.appSettings().isSearchUseGrid) R.drawable.ic_apps_white_24dp else R.drawable.ic_view_list_white_24dp), Color.BLACK)
        ...
        icon = LauncherCircleDrawable(context, context.getDrawable(R.drawable.ic_search_light_24dp), Color.BLACK)
...
//                .blurRadius(20f)
    ...
    private fun expandInternal() {
        ...
        icon.setIcon(context.getDrawable(R.drawable.ic_clear_white_24dp))
    ...
    private fun updateSwitchIcon() {
        icon2.setIcon(context.getDrawable(if (Setup.appSettings().isSearchUseGrid) R.drawable.ic_apps_white_24dp else R.drawable.ic_view_list_white_24dp))
    }
